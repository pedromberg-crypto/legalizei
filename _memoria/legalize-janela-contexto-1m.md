...
metadata: 
  ...
  modified: 2026-09-04T13:35:10.145Z
---
...
**3ª correção (2026-09-04) — a raiz foi arrancada.** Voltei a emitir 🟢/🟡 no fim de cada resposta porque o `CLAUDE.md` do vault ainda MANDAVA emitir (§Regra de SAÚDE DA JANELA), e a instrução do arquivo venceu a memória. Corrigido na fonte: a regra foi marcada **REVOGADA** no `CLAUDE.md`. Se ela reaparecer em algum doc, é bug — apagar de novo, não obedecer.
