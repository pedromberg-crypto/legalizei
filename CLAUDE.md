...
- 🆕 **`produto/` é o produto, dividido por regime e depois por ciclo de vida** (reorg de 17/09). `_`-prefixo = transversal, serve os dois regimes; nome limpo = ramo.
  ...
  - **`produto/me/`** — `entrar/{constituir,migrar}` (as duas portas) · `viver/` (o dia-2: o **`motor/`** com `regra · vidas · provar · rodar · publicar · notas`, e o **`processos/`** com o board e o modo cru) · `desenquadrar/` (saída para EPP) · `devs/` (a entrega gerada).
