# Relatório T0085 — persona "fronteira" (Fernanda — "consultoria de alimentação e bem-estar")
...
| 06 | B1·4      | b1.veredito      | 🟡 waitlist                                                 | ✅  | 🟡 hoje soa 'não fazemos'. Mas nutri registrada PODE operar com responsável técnico (RT/CRN). 2ª ordem: separar 'fora do nosso escopo por ora' de 'você precisa de RT pra abrir' — senão ela espera eternamente por um caminho que já existe hoje. |
