...
*(Este arquivo fundiu o antigo `03-DOMINIO-CONTABIL` com o `06-REGRAS-ORGAOS-PUBLICOS`. Eram dois textos dizendo a mesma coisa com palavras diferentes, e isso é como o dado começa a divergir.)*
...
* 🔴 **Você não decide isso de cabeça, por profissão.** Consulte a atividade antes de responder (ver `11-COMO-CONSULTAR-CNAE`). Dizer "você não pode ser MEI" pra quem pode custa uma venda, e o contrário custa um processo indeferido.
