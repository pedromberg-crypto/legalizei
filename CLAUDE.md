...
- 🥩 **Modo cru (12/09):** varredura por CATEGORIA do PDF de 58, sem quem executa, sem tela, sem API, sem semáforo. Fonte em `execucao/processos/cru/`, regras em `cru/_como-funciona.md`, vista no `/processos` pelo seletor. O formato completo (P1–P6) **não foi revogado, foi adiado**: as conexões e as APIs entram depois que todas as categorias estiverem varridas.
