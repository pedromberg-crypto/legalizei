# Relatório T0033 — persona "bloq-3socios" (Bloqueio 7 — 3 sócios (acima do limite))
...
| 10 | B2·8      | b2.socios        | ERRO: acima de 2 sócios: atendimento humano | ✅  | Bloqueio tem que oferecer saída (atendimento humano), não só 'não'. Explicar que é limite do produto, não da lei. |
