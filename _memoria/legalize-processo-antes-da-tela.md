...
**How to apply:**
- Fonte: `produto/me/viver/processos/processos-data.mjs`. Gerador cospe **duas saídas**: `/processos` (board visual pro Pedro) e `PROCESSOS.md` (nota pro dev). Nunca editar as saídas.
...
Regras completas: `produto/me/viver/processos/_doutrina-processos.md`, que tem uma seção de **memória com os meus erros datados**, a pedido do Pedro ("não quero ver erro básico se repetindo").
