...
| L | **Teste da mecânica de engajamento recorrente (item 7 do `mapa-itens-travados-criacao-post.md`)** — 5 propostas novas de mecânica escritas em `mecanicas-engajamento.md`, aguardando o teste prático de geração de post | Pedro pausou pra tratar a reunião Rua Satélite 36 (fluxo/telas do app) | 2026-08-26 | Assim que a reunião Rua Satélite 36 for avaliada e fechada |
| K | ✅ **RESOLVIDO 05/08** — ~~Base de tom-de-voz/copy insuficiente pra validar telas~~. Criados [[glossario-tecnico-humano]] (18 termos, tradução puxada de copy real já em produção) + [[exemplos-copy-por-tela]] (padrão erro/vazio/sucesso/aviso legal, com exemplo-fonte citado por tipo) | Pedro pediu validação de copy E1-E4.5 contra "o produto como um todo" (05/08) | 2026-08-05 | Próximo: rodar a validação E1-E4.5 usando os 2 docs novos como régua |
