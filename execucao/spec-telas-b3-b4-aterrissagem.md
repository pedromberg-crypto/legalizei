...
- **🔴 UX-32 APOSENTADO (16/07):** ~~a barra do wizard continua nesta cauda~~. **NÃO continua** → [[design-system]] §0. No B4 o gargalo é a JUCEMG, não o cliente, e o N21 já tem a própria timeline. **O que a barra fazia e ainda precisa existir:** mostrar o **custo já assumido** — isso vira elemento do painel (N21), não barra.
