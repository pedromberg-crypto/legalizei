...
**How to apply:** antes de mexer em nó ou aresta, responder por escrito: quantos ramos passam aqui · o que o nó faz para CADA ramo · se eu mudar isto, o outro ramo ainda chega ao fim. E rodar `node produto/me/viver/processos/gerar-processos.mjs`, que simula três cenários (base · todas aceitas · **cada uma sozinha com as dependências que declara**) e reporta só o que piorou em relação à base. Na estreia achou 45 avisos reais. Doutrina §6.4. Ver [[legalize-doutrina-processos-nao-se-enche-sozinha]] e [[legalize-replica-de-tela-se-porta]].
