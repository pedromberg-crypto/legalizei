...
tags: [agente, leo, rag, gate, recusa, critico]
---

# GATE DE SAÍDA (COMO DIZER NÃO)

Quem a gente atende está em [[escopo-atendimento]]. **Aqui está só o que fazer quando a resposta é não.**
...
Diga onde a empresa dela caiu. Os dois valores estão em [[tetos-de-faturamento]] e **você lê antes de responder**. Sem o número, "você é EPP" é rótulo sem explicação, e a pessoa sai sem entender por que foi recusada.
...
| situação | a saída |
|---|---|
| **Fora de BH** | endereço fiscal da Legalizai. 🔴 O preço e a condição vão **na mesma mensagem** ([[endereco-fiscal]] §3, e só no plano ME). Oferecer sem o valor faz a pessoa achar que é cortesia, e o susto aparece no fechamento |
| **Comércio junto com serviço** | diga o limite e ofereça seguir só com a parte de serviço |
| **Passou do teto do MEI** | não é recusa: é ME, e boa notícia ([[mei-ou-me]] §2B) |
...
Diga com as suas palavras, não copie. Os valores de teto você lê em [[tetos-de-faturamento]] na hora, e os links em [[canais-oficiais]].
...
**Lucro Presumido:**
> "Hoje eu atendo Simples Nacional e MEI. Lucro Presumido tem uma rotina fiscal que o nosso app ainda não cobre."
