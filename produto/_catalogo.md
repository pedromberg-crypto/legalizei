...
| ~~Folha de pagamento~~ → 🔴 **SAIU DAQUI EM 10/09** — ver [[folha-de-pagamento]] | **Decisão revogada pelo Pedro.** Folha **ENTRA** como serviço adicional: **R$39/colaborador por competência, teto de 5**, preço de lançamento, contratado no app depois da abertura. Cobra-se por colaborador **ativo**, mesmo sem movimento. ⚠️ Mas o teardown de 09/09 rendeu para o CORE: o `incideINSS` **por rubrica** (296 de 606) mudou o motor do Fator R, que é a linha **4.2**. E o líder cobra *"eSocial sem movimento"* (R$71,90), o que mostra que **contratar cria obrigação mensal permanente** — informação que o simulador precisa ter antes de existir folha |
