...
| 🆕 **QUE TELA cobre qual funcionalidade** · o que cada tela do portal entrega | `caps` e `cobre` em [[portal-data]] + o painel de [[HOME-produto]] | ❌ `execucao/portal/matriz-portal-interno` é de **22/07** e virou histórico em 11/09: mostra o mapeamento da primeira leva, não o de agora |
