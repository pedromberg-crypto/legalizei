...
import { apurarDAS, fatorR, fatorRDeCompetencias, anualiza, rbt12De, retencaoLegitima, anexoDoCnae, vencimentoDe, custoTotalMensal, darfDoProLabore, guiaVencida, brlDeCentavos, emCentavos, LACUNAS, RESOLVIDAS } from "../regra/apurador.mjs";
...
/* ── G9 · o anexo antes do cálculo, e o calendário ─────────────────────── */
{
  ...
  const fixo = anexoDoCnae("III");
  const dinamico = anexoDoCnae("III-ou-V");
