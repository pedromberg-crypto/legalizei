...
deriva_de: [mercado-bh-regional, PESQUISA-MERCADO, posicionamento, naming-defesa]
tags: [marca, copy, pitch, video, mercado, escalada]
---

# 🚀 Roteiro de escalada — 3 propostas (v4)

> Substitui a abordagem de [[roteiro-marca-e-visao]] (que abria pela marca: nome, cor, AI). **Direção do Pedro:** o apelo começa pela **possibilidade de mercado** e vai **escalando** até o fecho de prontidão. Áudio épico crescendo junto, cada corte precisa deixar o espectador querendo o próximo.
>
> Público: investidor / aceleradora. Narração em [[narracao-elevenlabs-escalada]].

## v4 — respiração (13/08, fim de tarde)

**O defeito que o Pedro pegou:** frase longa lida em bloco vira **informação**, não impacto. O exemplo dele foi *"Vinte e dois anos de contabilidade de verdade por baixo"*, que entrega um ativo de 22 anos com a mesma entonação de quem lê uma etiqueta.

**A regra aplicada nas três: uma ideia por respiração.**
...
- **v3:** tempo verbal de lançamento (o app ainda não existe, então "vamos começar", não "começamos") + fecho sem eco (saiu o "Legalizai." falado; a peça termina em "Vai, legaliza aí" com o logo entrando e o **AI acendendo em coral** na sílaba tônica).
- **v2:** dieta numérica. Teto de **4 números por peça**, nacionais fixos (7,4 milhões + 0,7%) e regionais variando. Com 8 números o espectador processa planilha; com 4, ele decora.
- **v1:** três mecânicas de escalada nascem aqui (grandeza, pergunta, geografia).
...
|---|---|---|---|
| 0-12s | pulso solo, quase nada | "Agora, enquanto você assiste isso... alguém no Brasil está abrindo uma empresa." | mãos num celular, madrugada |
| 12-30s | baixo entra | "Ela não sabe qual imposto vai pagar. / Não sabe se escolheu o código certo. / E vai descobrir isso um ano depois. Quando não dá mais pra corrigir." | papéis, guia vencida, olhar cansado |
| 30-36s | **corte seco** | "E não é uma pessoa." | preto, respiro |
...
**O gancho de retenção:** a peça começa como história de uma pessoa, e o espectador ainda não sabe que é um pitch. Quando o "sete milhões e quatrocentas mil" entra aos 36s, ele reinterpreta tudo que viu.
**Risco:** os 30 segundos iniciais sem número exigem imagem boa. Com stock genérico, morre.
...
| Tempo | Áudio | Texto | Imagem |
|---|---|---|---|
| 0-10s | trilha entra direto, média | "Uma pergunta. / Quantas empresas brasileiras vivem hoje no Simples Nacional?" | pergunta escrita, fundo escuro |
| 10-18s | peso entra | "Sete milhões e quatrocentas mil." | número tomando a tela |
...
**O gancho de retenção:** o silêncio. As quebras secas param a trilha no meio, e som que some prende mais que som que cresce. A pergunta escrita segura quem está sem áudio.
**Risco:** formato de pergunta é o mais "publicitário" dos três. Numa banca seca, trocar "Uma pergunta." por "Um número." e manter o resto.

---

# Proposta 3 · A ONDA · ~105s

**Mecânica:** geografia. A câmera nunca volta pra trás: uma cidade, um estado, um país. A ambição do fim soa inevitável porque o movimento já aconteceu três vezes na tela. Minas e Brasil entram **sem número**, como movimento.
...
| Tempo | Áudio | Texto | Imagem |
|---|---|---|---|
| 0-14s | piano solo | "Belo Horizonte abre uma empresa em onze horas. / É a abertura mais rápida do Brasil. / Na terceira capital que mais abre empresa no país." | relógio, rua de BH de manhã |
| 14-26s | piano + baixo | "E a gente não vai começar aqui porque é pequeno. / Vai começar... porque é o campo de prova mais rápido que existe." | BH aéreo, movimento |
| 26-36s | cordas entram | "Se o produto aguentar a cidade que mais acelera... ele aguenta o país." | zoom out lento |
| 36-46s | cordas cheias | "E o país... são sete milhões e quatrocentas mil empresas no Simples Nacional." | mapa do Brasil acendendo |
| 46-56s | pausa suspensa | "Com o maior aplicativo contábil do Brasil atendendo... zero vírgula sete por cento delas." | 0,7% sobre o mapa |
| 56-66s | percussão entra | "Esse mercado não está consolidado. / Ele ainda está por ser servido." | mapa quase todo apagado |
| 66-78s | sobe em degraus | "Primeiro... Belo Horizonte. / Depois... Minas. / Depois... o Brasil inteiro." | três ondas no mapa, uma por frase |
| 78-90s | quase no topo | "Mesmo motor. Mesmo preço fechado. Mesmo contador de verdade atrás. / E por baixo de tudo... vinte e dois anos de contabilidade real." | app + selo 22 anos |
| 90-102s | topo | "Não vai ser uma contabilidade de bairro querendo crescer. / Vai ser um produto nacional que escolheu onde nascer. / E estamos prontos para ser o maior aplicativo contábil do Brasil." | Brasil aceso inteiro |
| 102-104s | **silêncio** | (nada) | preto |
...
**O gancho de retenção:** o mapa. É a única em que a escalada é **visível** sem depender da locução, e a única que responde antes de perguntarem a objeção nº1 pra negócio regional: *"isso escala fora de BH?"*
**Risco:** a mais longa. Se precisar cortar, o bloco de 26-36s ("se o produto aguentar a cidade que mais acelera") sai com menos perda, porque a ideia se repete no fecho.
...
| Gancho de retenção | a virada dos 36s | o silêncio depois da pergunta | o mapa abrindo |
...
- A abertura da Escada (a pessoa, 0-36s) plugada na frente da Onda daria a peça mais forte do conjunto, com custo de ~30s a mais.
- O fecho da Onda (*"não vai ser uma contabilidade de bairro querendo crescer"*) é a frase mais forte pra investidor das três e cabe em qualquer uma.
- A inversão *"por baixo de tudo isso... vinte e dois anos"* funciona nas três, e é o melhor lugar pro lastro do Mauro aparecer.
...
- 🔴 **Escolher a mecânica** (consequência, pergunta ou geografia), ou aprovar uma fusão.
- 🟡 **Duração:** com a respiração nova, as três passam de 1min30. Se houver teto rígido de tempo na apresentação, avisar: o corte sai do meio (bloco de produto na Loops, bloco de prova na Onda), nunca do fecho.
- 🟡 **Trilha:** os beats assumem faixa que cresce e nunca decresce, com espaço pra 2 ou 3 cortes secos. Escolher a faixa **antes** da locução, porque a fala se encaixa nela, não o contrário.
...
- 🟡 **Imagem dos 30s iniciais da Escada.** É a proposta com maior teto emocional e a mais dependente de imagem real.
- 🟢 **Números:** aprovados como estão, troca fácil depois de pesquisa externa. Todos com fonte na tabela acima.

## Links
[[narracao-elevenlabs-escalada]] · [[roteiro-marca-e-visao]] · [[roteiro-teaser-investidor]] · [[roteiro-pitch-acelerador]] · [[mercado-bh-regional]] · [[PESQUISA-MERCADO]] · [[posicionamento]] · [[decisoes-marca]] · [[HOME]]
