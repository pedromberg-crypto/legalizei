 ...
 * `verificar-tudo.mjs` roda da raiz. Rodar o script direto, de outra pasta,
 * estourava. Agora é resolvido contra a raiz achada, não contra o acaso.
 */
const REL = "produto/me/viver/motor/notas/_duvidas-contador.md";
const DOC = resolve(RAIZ, REL);
