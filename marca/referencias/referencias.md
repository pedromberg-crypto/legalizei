...
|---|---|---|
| Contabilizei | navy #002868 + ciano #04f7f7 | Azul institucional "banco/escala" |
| Facilite | azul-royal #1371ec | Azul quente (funde no líder) |
| Contabilivre | verde #57d300 + ciano #13b5ea | Verde-limão + azul |
| Contaja | verde-limão #b1ce0b | Verde budget/popular |
| Marvee | teal #5bc0be + navy #1c2541 | Teal premium-morno |
| **Agilize** | **roxo #7537ae** + menta | **Único fora da curva** |

**Leitura:** o setor é um **MAR AZUL-ESVERDEADO.** Azul = 3 (Contabilizei, Facilite, Contabilivre). Verde = 3 (Contaja, Contabilivre, Marvee-teal). Roxo = 1 (Agilize). **Azul é o default de "confiança fiscal" = zero diferenciação + alto custo de memória.** Quem escapou (Agilize roxo, Contaja limão) ganhou distinção de graça.

## 🅰️ Mapa de TIPOGRAFIA
Todas sans-serif arredondadas/amigáveis: Lato · Museo Sans Rounded · effra · Raleway · Palanquin · Poppins. **Nenhuma tem wordmark com caráter — todas invisíveis/genéricas.** → assinatura tipográfica é diferenciador barato e livre.

## 🎭 Mapa de ARQUÉTIPO
| Concorrente | Arquétipo | Tom |
|---|---|---|
| Contabilizei | Sábio/Governante | Autoridade fria, "a maior" |
| Agilize | Fora-da-lei lite (Nubank-ish) | Disruptivo, simpático, valor |
| Contaja | Cara-comum (Everyman) | Popular, barato, acessível |
| Facilite | Prestativo + Mago | Cuidar + transformar (nicho Airbnb!) |
...
## 🧲 Modelo de venda
Self-service: Contabilizei, Agilize, Contaja. Consultivo ("fale com especialista", sem preço): Facilite, Marvee. Contabilivre híbrido.
...
2. **Cor-âncora ownável fora do azul:** o vazio real é **quente — coral/laranja** (inexistente no nicho) OU um **esmeralda sério/teal com peso** (confiante + moderno, longe do limão budget). Coral = mais ousado/diferenciador; esmeralda = mais seguro. A decidir na identidade visual.
3. **Sistema de 2 cores disciplinado** (lição da Agilize): 1 cor de marca com personalidade + **1 cor de acento DEDICADA só pro CTA** (nenhum concorrente faz bem).
...
## Links
- [[conceito-marca]] · [[naming-defesa]] · [[marca]] · [[_relatorio-auditoria]] · [[HOME]]
