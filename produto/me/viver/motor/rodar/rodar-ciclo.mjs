...
import { calendarioDaCompetencia, MENSAIS, ANUAIS, placarDeAutomacao } from "../vidas/ciclo-do-cnpj.mjs";
import { vencimentoDe, anexoDoCnae, emReais } from "../regra/apurador.mjs";
