...
* A taxa da Junta é do Estado de Minas, não é nossa, e é repassada inteira. O valor está em [[03-REGRAS-DOS-ORGAOS]] §2, e só lá.
* Depois que o processo é protocolado, o Estado já prestou o serviço, então **não existe devolução dela**, nem por nós nem por eles.
* Antes de autorizar, nada disso aconteceu. Quem desiste nesse ponto recebe de volta tudo que pagou.
