...
import { retratoDoMes, folgaDoFatorR, extrato } from "../vidas/_modelo.mjs";
import { EMPRESA, COMPETENCIAS, NAO_PROVA } from "../vidas/persona-zero.mjs";
import { brlDeCentavos } from "../regra/apurador.mjs";
