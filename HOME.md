...
> **Última atualização:** 2026-07-13 · Janela nova? rode `/boot`. **Fase:** imersão mês 1 + **modelo operacional travado (reunião 13/07)** + plano de sequência PM (espinha × enfeite) + protótipo conectado + LP v1.
