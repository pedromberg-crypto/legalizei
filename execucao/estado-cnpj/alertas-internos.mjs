...
import { vencimentoDe, emCentavos } from "../motor-fiscal/apurador.mjs";
import { proLaboreParaManterNoIII } from "../motor-fiscal/piloto-pro-labore.mjs";
import { FATOR_R } from "../motor-fiscal/_tabelas.mjs";
