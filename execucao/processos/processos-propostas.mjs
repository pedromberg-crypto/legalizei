...
export const PROPOSTAS = [
   ...
   * ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    },
    {
      ...
      forma: "decisao",
      fonte:
        "Decisão do Pedro em 11/09: “só será iniciado/liberado após efetuação do pagamento desse serviço.” O gate na captura é recomendação minha, aguardando o ok dele.",
      duvida:
        "Falta o ok do Pedro no gate ser a CAPTURA: autorização só reserva limite (dinheiro nenhum se moveu, e se a captura falhar depois a gente entregou de graça) e liquidação é D+30 no cartão (esperar isso mata o produto). E falta decidir a espera: a pessoa fica na tela até confirmar, ou o app deixa ela sair e avisa depois? Com boleto, que leva dias, ficar na tela não é opção.",
    },
    {
      id: "S10c",
      processo: "P4",
      ...
      quem: "a casa",
      faz: "Mantém o pedido parado por 72 horas, com o preço e o aceite ainda travados, e fora da fila de execução. Deixa a pessoa retomar o pagamento de onde parou.",
      fala: "só a nossa casa",
      ve: "O item aparece como “aguardando pagamento”, com o tempo que resta e o botão pra pagar. Nada de “em andamento”.",
      luz: "verde",
      forma: "passo",
