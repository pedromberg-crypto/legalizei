 ...
 *
 *   🔴 [ENCERRADO] CPP dentro do DAS CONTA no numerador, e é PACÍFICO (SC COSIT 17/2021).
 *      ⚠️ **ESTA LINHA ESTAVA ERRADA E FICOU AQUI POR TRÊS DIAS.** Refutada em
 *      14/09 contra norma literal: a Res. CGSN 140/2018 art. 26 §2º I 'a'
 *      nomeia **só o Anexo IV**, e o silêncio sobre III e V é vedação. A CPP
 *      **não entra**. Mantida riscada em vez de apagada, porque o que ela
 *      ensina não é a regra, é o modo de errar: eu declarei "pacífico" uma
 *      leitura de uma solução de consulta que trata de matéria diversa.
...
export const CATEGORIA = {
  ...
  emoji: "👥",
  itens: ["4.1", "4.2", "4.3", "4.4", "4.5", "4.6", "4.7"],
};
...
export const NOS = [
  ...
  // ── C · A VIGÍLIA DA JANELA MÓVEL ────────────────────────────────────────
  {
    ...
    saidas: [
      ...
      { se: "perto de perder a tributação pelo Anexo III", vai: "L17" },
      { se: "o mês que vai SAIR da janela tinha folha alta", vai: "L17" },
      { se: "já perdeu a tributação pelo III e dá pra recuperar", vai: "L18" },
    ],
    cobre: ["4.2"],
    ja: "P5.11",
