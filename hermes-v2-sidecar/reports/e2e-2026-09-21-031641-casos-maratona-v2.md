...
**Quando:** 2026-09-21T03:16:41.354Z · **Modelo:** `gemini-3.1-flash-lite` · **Suite:** casos-maratona-v2 · **Casos:** 1
...
|---|---|
| placar | **0/1** |
| custo da rodada | US$ 0.016940 |
| custo por caso | US$ 0.016940 |
| chamadas ao modelo | 30 |
| tokens de entrada | 310.944 |
| **dos quais em cache** | **285.978** (92.0%) |
| sem cache custaria | US$ 0.081285 |
| **economia do cache** | **US$ 0.064345 (79.2%)** |
| tokens de saida | 2.366 |
| razao entrada/saida | 131.4 para 1 |
...
Turnos sem lastro tecnico: **1**. Cada um e um turno em que nenhuma
...
**Rota:** tecnico → comercial → comercial → comercial → tecnico → escalonamento → comercial → comercial → tecnico → comercial · **427 chars** · 43331 ms
...
> Boa! O link pra entrar na Lista VIP é esse aqui: https://www.legalizai.com.br/em-breve
> 
> Entrando por aí, você garante o preço promocional de R$ 99 nos três primeiros meses, válido para quem entrar na lista até 31 de dezembro de 2026. Quando a gente liberar a abertura, você é avisado e já começa com esse desconto.
> 
> Já aproveita e segue a gente no Instagram pra acompanhar as novidades: https://www.instagram.com/legalizai.app/
