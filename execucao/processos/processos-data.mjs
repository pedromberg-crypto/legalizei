...
export const PASSOS = [
  ...
  },
  {
    ...
    quem: "a casa",
    faz: "Acompanha o Fator R dos 12 meses e avisa quando a empresa está perto de cair pro Anexo V, com quanto falta de pró-labore pra evitar.",
    fala: "só a nossa casa",
