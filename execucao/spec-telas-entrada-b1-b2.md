...
- **Mapa da jornada (UX-32):** barra de progresso não é só uma linha — mostra **onde estou / quanto falta / quanto já custou** no arco inteiro entrada→B4→ativa (~30 passos). O leigo (reta/cida) não trava sem mapa; o experiente (knife/monstro) quer saber o estrago antes. Persistente da entrada até a aterrissagem.
