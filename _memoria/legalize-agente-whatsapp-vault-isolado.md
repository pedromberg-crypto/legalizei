...
metadata:
  ...
  modified: 2026-09-19T20:41:11.657Z
---
...
🔴 **O Léo NÃO está com cliente** (travado pelo Pedro em 19/09). Ele está só na mão da equipe interna do projeto. **Nunca priorizar item argumentando "está machucando usuário agora"** — não existe usuário. A ordem de trabalho é a da reorganização (medir → alinhar teste e runtime → mecanismo → documentação), não a de urgência de produção. Quando o lançamento mudar isso, esta linha cai.
