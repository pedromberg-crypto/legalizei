...
## 1. Essência (a marca em 1 frase)
**A contabilidade que fala a sua língua e cuida do chato pra você.**
Digital de verdade, humana, sem contabilês — pro pequeno prestador de serviço que só quer tocar o próprio negócio.

## 2. Propósito (o porquê)
...
| **Transparente** | Mostra custo e prazo na cara, sem surpresa (a dor nº1 do mercado) |
| **Proativo** | Avisa antes, resolve antes — não manda o problema pro cliente |
| **Descomplicado** | Traduz o contabilês; 1 toque em vez de 6 cliques |
| **Confiável** | Segurança séria por trás da leveza (A1 blindado, 2FA) — leve na cara, sólido no motor |
...
| Mobile-first de verdade | "Mobile-first" no marketing, quebrado na prática |
| Transparente no custo | Surpresa de taxa depois |
| Leve na cara, séria no motor | Nem corporativo-engessado, nem amador |

## 7. Território visual que o conceito sugere (ponte pros pixels)
> Direção, não decisão — a identidade visual detalha na próxima etapa.
