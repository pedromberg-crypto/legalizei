# Relatório T0011 — persona "knife" (Gustavo — consultor de TI solo (Fator R na borda + boleto))
...
| 15 | B2·13     | b2.simulador     | est. Fator R 28% → Anexo III (6%) · já otimizado               | ✅  | Na borda (28% cravado) mostrar a sensibilidade: 'um real a menos de pró-labore te joga pro Anexo V'.  |
...
| 20 | B3·18     | b3.pagamento     | pagamento não pago (boleto) · dunning · NÃO destrava B4        | ✅  | Boleto fora do happy path: deixar explícito que a abertura só começa quando compensar. Dunning claro. |
