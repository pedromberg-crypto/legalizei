...
flowchart TD
  ...
  A3_H["A3.H · Passagem<br/>pra consultora"]
  A3_H1["A3.H1 · Marcar horário<br/>com a consultora"]
  A3_H2["A3.H2 · Status<br/>(horário marcado)"]
  ...
  A3_H2 -.->|"assinaturas feitas com a consultora"| A5_H
  A3 -.->|"ME · DAE paga"| A4
...
| 89 | ✅ A5.H · Home dia-1 · (rota assistida) | — | ✅ | 🟡 | 🔴 Como a consultora avisa que o CNPJ saiu (push, WhatsApp, os dois) é decisão de operação + dev. 🔴 O passo da procuração fica sem CTA de propósito: a conversa já está aberta no WhatsApp, e um botão aqui abriria um segundo canal pro mesmo assunto. |
