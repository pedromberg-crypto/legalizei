...
ordem: 1
papel: "Preços, promoções, endereço fiscal, taxa da Junta"
tags: [agente, leo, rag, preco, plano, oferta]
---
...
## 1. Plano MEI
* **Preço:** R$ 49 por mês.
* **Promoção dos 3 primeiros meses:** R$ 29 por mês, depois vai pra R$ 49.
* **Inclui:** abertura sem honorário, manutenção mensal, emissão de guias e assistente virtual de contabilidade.
* **🔴 Não inclui contador humano dedicado.** O suporte do MEI é virtual. Nunca prometa nem dê a entender o contrário.
* **🔴 Certificado digital: não está incluso no plano MEI.** Quem é MEI **paga à parte**.
* 🔑 **A distinção que evita a resposta errada:** pra **a pessoa emitir a própria nota**, o MEI **não precisa** de certificado — o padrão nacional aceita a conta gov.br dela. Pro **nosso app trabalhar por ela** (emitir guia, agir nos sistemas dos órgãos sem pedir senha a cada vez), o certificado **é necessário**. As duas coisas são verdade ao mesmo tempo, e dizer só a primeira deixa a pessoa achar que nunca vai precisar.

## 2. Plano ME (Microempresa no Simples Nacional)
* **Preço:** R$ 139 por mês.
* **Promoção dos 3 primeiros meses:** R$ 99 por mês, depois vai pra R$ 139.
* **Inclui:** contador humano com registro no CRC cuidando da rotina fiscal, o app com acompanhamento, e o **certificado digital e-CNPJ incluso, sem custo extra** (fora daqui, certificadoras cobram em torno de R$ 209 por ano).
* **Abertura sem honorário:** a gente não cobra pra abrir. A receita é a mensalidade.

## 3. O que NÃO está aqui, e por quê

Esta nota é só o **comercial**: quanto custa, o que inclui, a promoção e como fechar. Duas
coisas que costumavam morar aqui saíram, porque não são venda e faziam esta nota abrir em
conversa que nunca ia falar de preço:

* **Endereço fiscal** (o add-on de sede em BH) → [[03-REGRAS-DOS-ORGAOS]] §1, junto da regra
  da Prefeitura que o torna necessário.
* **Taxa da Junta** → [[03-REGRAS-DOS-ORGAOS]] §2, junto do órgão que a cobra.

🔴 **O valor de nenhuma das duas está escrito aqui.** Se a pergunta for sobre elas, leia o
