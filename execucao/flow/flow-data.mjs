...
export const NODES = [
  ...
  { id: "M4_1", caminho: "mei", rota: "/mei/conta?etapa=codigo", label: "M4.1 · Confirmar código", forma: "tela", classe: "branch", status: "construida", validado: "ux", falta: "🆕 07/09 — estado interno da M4, com deep-link próprio (mesmo padrão que o ME adotou em 04/09 pro E6.1). Sem a rota, o estado fica indistinguível no mapa e ninguém consegue revisar", dados: "Código de 6 dígitos" },
...
export const EDGES = [
  ...
  { de: "M6_S", para: "M7", tracejado: true },
  { de: "M6_SB", para: "M7", tracejado: true },
  { de: "M7", para: "M8", label: "ocupação escolhida" },
  { de: "M8", para: "M9" },
  { de: "M9", para: "M10" },
  { de: "M10", para: "M11" },
  ...
  { de: "M14", para: "A5", label: "certificado resolvido" },
