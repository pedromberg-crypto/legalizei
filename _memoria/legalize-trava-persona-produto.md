...
**How to apply:**
1. Fonte e `produto/me/viver/processos/_persona.mjs` (19 travas com fonte+data, persona zero, perguntas abertas como DADO). `verificar-persona.mjs` roda nos 3 geradores.
