...
**`produto/me/viver/motor/regra/`** é a fonte de tudo que é regra fiscal. (Era `execucao/motor-fiscal/` até 17/09, quando o motor inteiro passou a morar no ciclo de vida do ME.)
