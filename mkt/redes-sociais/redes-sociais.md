...
## 🔖 Contas oficiais (registro-verdade)
...
> Handles/logins ficam no Bitwarden "Legalize" — aqui só o registro público. Senha crua nunca no vault.

## 🧭 Padrão por rede

Cada pasta (`instagram/`, `linkedin/`…) contém:
- **`perfil-*.md`** — dados da conta, bio, setup, status de preenchimento.
- **`estrategia-*.md`** — posicionamento, pilares de conteúdo, cadência, métrica-alvo (criar quando for destrinchar).
