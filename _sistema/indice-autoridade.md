...
| 🆕 **O que o elenco de vidas NÃO exercita** | `execucao/processos/_cobertura-das-vidas.md` — mora em `/processos` porque quem o escreve é o `gerar-cru.mjs` | ⚠️ a régua é *"existe código que nenhuma vida faz rodar?"*, não *"temos personas suficientes?"* |
