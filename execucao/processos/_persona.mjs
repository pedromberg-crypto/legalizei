...
export const ABERTO = [
  ...
  },
  {
    ...
    resposta:
      "RESPONDIDA EM 14/09 (Pedro). 🔑 A pergunta se parte em DUAS, e só uma metade era de verdade. (1) MOSTRAR — não mostramos. Nada de painel de 'lucro disponível'. O líder também não mostra (o Pedro foi cliente e nunca viu), e sem conciliação bancária (item 31, travado no mesmo dia) qualquer número exibido seria errado: o balanço real tem receita toda em 'a receber', pró-labore todo em 'a pagar' e caixa a −5.012,83. Painel de lucro em cima disso manda a pessoa sacar dinheiro que não existe. (2) DECLARAR — obrigatório, e não é escolha nossa. O lucro é DECLARADO PELO CLIENTE, num campo, com prazo mensal, e a casa leva pra EFD-Reinf. Não é inferido de extrato, não é calculado, não é conferido por nós. Se a retirada declarada for maior do que a contabilidade suporta, cai na decisão 32: vira empréstimo ao sócio em Créditos com Pessoas Ligadas, SEM bloquear e SEM avisar.",
    critico: true,
    fonte:
      "Pedro, 14/09 · Lei 15.270/2025 (via Termo de Ciência do líder, [[2026-09-10-contabilizei-aceites-LITERAL]]) · Resolução CFC 1.590/2020 art. 3º · [[2026-09-14-declaracao-anual-e-informe-de-rendimentos]] §4",
    porque:
      '🔴 VIROU OUTRA PERGUNTA, e maior. A original era "a persona tira lucro?". O Pedro respondeu algo mais fundo: *"a Contabilizei em momento nenhum nem cita sobre retirada de lucro, então com toda certeza é algo que é calculado por trás e vem com respostas apenas que o usuário precisa saber"*. Bate com a evidência: na plataforma do líder o lucro é INFERIDO DO EXTRATO, silenciosamente, e nunca é perguntado. ⚠️ E a casa travou em 09/09 que não teremos conta nem integração bancária — então o caminho dele não existe pra nós. 🔑 O QUE DESTRAVOU (14/09): o Pedro perguntou *"o quão esse valor é importante de verdade, sendo que eu não tive isso na Contabilizei?"* — e a premissa estava meio certa. Ele TEVE, só não VIU: estava atrás do Termo de Ciência que ele aceitou, que diz *"fornecer informações completas e precisas sobre as movimentações financeiras da sua empresa até o dia 15 de cada mês"* e *"a inclusão dos lucros após o prazo final acarretará multa, a qual será de responsabilidade do cliente"*. A Lei 15.270/2025 tirou a distribuição de lucro da invisibilidade anual e fez dela obrigação MENSAL na EFD-Reinf, com IRRF antecipado possível. 🔑 DE QUEM É A RESPONSABILIDADE: o instrumento já existe e não é nosso pra inventar — a Carta de Responsabilidade da Administração (Resolução CFC 1.590/2020, art. 3º) faz o cliente declarar que a informação é completa e verdadeira, e sem a assinatura dela o contábil não fecha. Nossa parte é PERGUNTAR EM TEMPO e DECLARAR O QUE FOI RESPONDIDO. Não descobrir, não conferir, não bloquear — a própria frase do Pedro em 13/09: *"não é nosso papel regular como é usado esse faturamento, temos apenas que fazer nossa parte de cálculos e guias corretas nas datas corretas"*.',
    muda:
      "⏳ SOBRA UMA DECISÃO, e é de prazo, não de descoberta: QUAL DATA a gente pede a declaração do lucro? O líder usa o dia 15. Herdar o 15 dele ou escolher a nossa é decisão do Pedro — ele não respondeu em 14/09. ⚠️ DUAS RESSALVAS ANTES DE VIRAR TELA: (a) a Lei 15.270/2025 chegou por CITAÇÃO EM TELA DE CONCORRENTE, e a regra do vault proíbe ratificar dado fiscal assim. Está corroborada de forma independente (a Reinf apareceu na DCTFWeb de 01/2026 da conta real), mas quer o texto legal na mão ou o ok da Larissa; (b) a multa de 50% sobre lucro distribuído com débito federal (art. 32 da Lei 4.357/64) é a justificativa que o LÍDER usa pra TRAVAR o lucro — comportamento que o Pedro derrubou em 13/09. Não copiar junto.",
  },
  {
    id: "P2.4",
    bloco: "socio",
