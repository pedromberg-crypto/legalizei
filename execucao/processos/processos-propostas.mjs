   ...
   * ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    mudancas: [
      { passo: "P4.10", campo: "titulo", valor: "Cancelou com avulso na fatura" },
      {
        ...
        campo: "faz",
        valor:
          "O contrato segue vivo nos 30 dias de aviso prévio. O avulso continua, é entregue dentro desse prazo e entra na fatura final, que tem que ser quitada até a data do encerramento.",
      },
      {
        passo: "P4.10",
        campo: "ve",
    ...
    depende: ["S6", "S11"],
    porque:
      "🔄 ESTREITADO em 11/09, aplicando a trilha. 🔑 E aqui a trilha fez o contrário do que fez no S6: em vez de DIVIDIR o passo, ela REVELOU que ele já era de um ramo só. Depois que o S11 mandou o caso do serviço já pago pro S11a, o P4.10 passou a ser alcançado apenas pela trilha da fatura — conferido na propagação, uma única entrada, `P4.8 → P4.10` com `quando: fatura`. O texto ganhou o nome certo e parou de fingir que valia pros dois. A 12.6 responde este caso com todas as letras (quitar tudo em aberto até o encerramento, incluindo serviços adicionais) e a 12.1 dá o prazo em que a entrega ainda cabe: o contrato não morre no clique, morre 30 dias depois. Por isso não existe “cancela o serviço junto”. O que a 12.6 não cobre é o avulso que NÃO dá pra entregar nesses 30 dias, e esse cai na régua do S6 pela aresta do S8. A tela precisa mostrar isso ANTES da confirmação, senão o cliente descobre a cobrança depois de cancelar, que é onde nasce reclamação.",
    },
