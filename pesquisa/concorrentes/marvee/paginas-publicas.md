...
**Não existe página de planos.** O link `/planos` retorna "link não encontrado" no capture. Isso não é lapso — é posicionamento. A ausência de preço público diz:
...
- **Headline da página sobre:** *"Quem vai cuidar da sua terceirização financeira?"* — enquadra como delegar/confiar um departamento a um parceiro. Emocional-operacional ("cuidar"), não transacional.
- **Paleta:** teal `#5bc0be` sobre navy `#1c2541` / slate `#3a506b`. Corporativo, sóbrio, "consultoria séria". Nada da vibe fintech colorida/casual dos apps de contabilidade para PME.
- **Tom = manifesto de cultura agressivo.** A seção "É nisso que a gente acredita" lista credos internos expostos ao público:
  - *"Não seja medíocre, pois a média é uma merda."*
  - *"Dinheiro não aceita desaforo."*
  - *"Dados comem feeling no café da manhã."*
  - *"Seja leve com as pessoas e pesado com os problemas."*
  - *"Assuma a responsabilidade ao invés de procurar culpados."* / *"Detalhes importam."* / *"Trabalhar dá trabalho."*
  - Âncora de propósito: *"Estamos aqui para apoiar o empreendedor brasileiro."*
- **Leitura:** marca construída sobre **pessoas + método + cultura forte**, não sobre produto/software. Vende confiança em um time ("Conheça os responáveis pela Marvee", responsáveis técnicos nominais com registro CRA/CRC). É o modelo "gente boa e competente cuidando do seu dinheiro" — inescalável por definição, e assumidamente assim.

## 🏢 Modelo de negócio (a página de FRANQUIA revela como escalam)

A página `/como-funciona-uma-franquia-de-bpo-financeiro` é o achado central: **Marvee não escala contratando — escala vendendo franquia.** Destrinchando o que o texto entrega:

- **O produto real da Marvee tem dois clientes:** (1) a PME que compra BPO; (2) o **empreendedor que compra a franquia** pra revender BPO. A página de franquia é uma isca de negócio (blog SEO "5 motivos para investir") mirando o segundo.
- **Pilares do pacote de franquia** (o que o franqueado compra): *Treinamento completo · Suporte contínuo · Tecnologia integrada · Modelo de negócios testado*. Ou seja: método + software + marca + processo padronizado. O ativo que a Marvee licencia é o **playbook operacional + a tecnologia**, não atendimento.
- **Promessa ao franqueado:** "negócio pronto para operar", "menos riscos", "reputação consolidada no mercado", pode ser **operado de casa (home office)**, **não exige formação em finanças**. Isto é: baixa barreira de entrada pro franqueado ⇒ maximiza número de franquias vendidas.
- **Preço/retorno também consultivos:** a FAQ "Quanto custa abrir?" responde *"varia dependendo do franqueado, tecnologia e suporte... consulte o plano financeiro da marca"* — de novo, sem número. Lucro projetado "12 a 3X meses". Nada quantificado publicamente.
- **BPO financeiro ≠ BPO contábil (eles próprios distinguem):** financeiro = contas a pagar/receber, fluxo de caixa, conciliação, emissão de NF; contábil = escrituração fiscal, impostos, obrigações. Marvee posiciona-se no financeiro (mais próximo do dia a dia de caixa) e oferece ambos "de forma integrada". **Contabilidade é acessório; o carro-chefe é o financeiro.**

**Como o dinheiro entra:** taxa de franquia + royalties/mensalidade dos franqueados + o BPO direto da unidade matriz. É um modelo de **rede distribuída**, sede em Blumenau/SC (Manoel Victor Torres — CRA-SC; Lindomar Becker — CRC/SC). Cresce em nós geográficos, não em usuários de um app.
