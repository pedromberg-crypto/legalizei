# Relatório T0016 — persona "reta" (Bruno — dev freelancer solo)
...
| 16 | B2·13     | b2.simulador          | est. Fator R 12% → Anexo V (15,5%) · ótimo R$4200 → Anexo III (IRRF zero)       | ✅  | Leigo não entende 'Fator R'. Mostrar em R$ ('pague-se X, economize Y'), não em jargão fiscal. Rotular 'estimativa'. |
...
| 20 | B3·17     | b3.aceite             | contrato + termo de início aceitos (assinatura)                                 | ✅  | Termo de início irreversível assusta o leigo. Explicar em 1 linha que taxas de governo não voltam, sem letra miúda. |
| 21 | B3·18     | b3.pagamento          | pagamento confirmado (cartao) · destrava B4                                     | ✅  |                                                                                                                     |
| 22 | B4·19     | b4.viabilidade        | viabilidade deferida (nome+endereço+CNAE) — JUCEMG unificada                    | ✅  | Pausa de órgão externo: mostrar 'estamos abrindo, leva ~X dias' pra ele não achar que travou.                       |
...
| 28 | B4·23     | b4.certificado::pausa | ⏸ parceiro emitindo certificado · espera algumas horas · ▶ retomada idempotente | ✅  |                                                                                                                     |
