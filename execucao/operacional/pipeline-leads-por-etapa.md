...
Fonte do mapeamento: [[flow-data]] (`execucao/flow/flow-data.mjs`, fonte-verdade) · [[mapa-ramificacoes-flow]] (as pausas) · [[fluxo-abertura-portais-pedro-dev]] (sequência dos órgãos, Izabela) · [[spec-kanban-leads]] · [[spec-dashboard-adm-metricas]] (o par métrico).
...
| # | Coluna | Dono (cor) | Flow ([[flow-data]]) | Entra quando | Sai quando | Operador faz | Relógio / alerta |
|---|---|---|---|---|---|---|---|
...
## 🔗 Cruza com
[[spec-kanban-leads]] (o Board A que este doc reformula) · [[handoff-sistema-gestao-dev]] §3.1 · [[mapa-ramificacoes-flow]] (pausas + saídas) · [[flow-data]] · [[fluxo-abertura-portais-pedro-dev]] (órgãos) · [[spec-dashboard-adm-metricas]] · [[HOME]].
