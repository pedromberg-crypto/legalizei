...
| 5 | **Teto de automação** | Descoberta validada pelos 3: o processo **não é 100% digital** (~15–20% exige humano) porque JUCEMG e Gov.br não têm API e exigem login manual. Ver [[2026-07-10-teto-automacao-orgaos-sem-api]] | 🟢 |
...
**Próximo:** fechar o logo e avançar no app.
...
4️⃣ *Descoberta* — nem o líder é 100% automático: ~15–20% do processo exige humano (órgãos como JUCEMG e Gov.br não têm integração). Confirmado pelos 3 ✅
...
Semana que vem: fechar o logo e avançar no app.
```
