# Relatório T0051 — persona "sociedade" (Diego + Elisa — agência de publicidade (2 sócios))
...
| 16 | B2·13     | b2.simulador     | est. Fator R 35% → Anexo III (6%) · já otimizado               | ✅  | Com 2 pró-labores a folha já passa 28% fácil → Anexo III. Mostrar a economia vs V em R$.                                               |
