# Relatório T0034 — persona "bloq-exterior" (Bloqueio 8 — sócio no exterior (único fatal))
...
| 08 | B2·6      | b2.socio         | ERRO: sócio no exterior: bloqueia opção Simples (LC 123 art.17 II) → rota humana | ✅  | Bloqueio precisa explicar que a empresa até existe, mas fora do Simples (produto). Oferecer rota humana, não crash. |
