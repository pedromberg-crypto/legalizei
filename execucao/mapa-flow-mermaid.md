...
flowchart TD
  ...
  C2["C2 · Vínculo INSS"]
  C3{"C3 · Sócios?"}
  C3_1["C3.1 · 3+ sócios<br/>(quem administra, por nome)"]:::branch
...
| 50 | C5.1 · Splash · 'já sabemos o que você faz' | — | ✅ | ⚪ | Reusa `SplashMensagemView` (mesmo componente de /splash-atendido e /splash-pagamento), com `?next=` e auto-avanço. Arte/copy provisórias, Pedro revisa. |
