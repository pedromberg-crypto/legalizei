...
- **Oportunidade Legalizai Story Book:** (a) espelhar o recorte deles no MVP (não reinventar o filtro — 13 anos validaram); (b) a lista de 17 recusadas é o **mapa do que NÃO construir no V1** (economiza esforço); (c) transparência: mostrar upfront "atendemos X, não atendemos Y" (eles escondem no suporte) = confiança + qualificação de lead.
